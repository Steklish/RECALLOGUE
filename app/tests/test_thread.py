...
def test_create_thread(db_session):
    ...
    thread_in = ThreadCreate(name="Test Thread")
...
def test_get_thread_by_id(db_session):
    ...
    thread_in = ThreadCreate(name="Test Thread for Retrieval")
    created_thread = thread_service.create(db_session, thread_in)
...
def test_get_all_threads(db_session):
    ...
    thread_in1 = ThreadCreate(name="Thread 1")
    thread_in2 = ThreadCreate(name="Thread 2")
...
def test_update_thread(db_session):
    # First create a thread
    thread_in = ThreadCreate(name="Original Thread")
    created_thread = thread_service.create(db_session, thread_in)
...
def test_delete_thread(db_session):
    # First create a thread
    thread_in = ThreadCreate(name="Thread to Delete")
    created_thread = thread_service.create(db_session, thread_in)
